...
export default function PublishWithVercel() {
  return (
    <DocsPage>
      ...
      <InfoBox>
        ...
        Vercel is actually a better choice for most people, so that's what we'll
        use here.
      </InfoBox>
      <Step number={1} title="Register for a Github account">
        ...
        <InfoBox>
          Github is a free service that stores text-based code, and it's used to
          sign in to both CodeSandbox and Vercel.
        </InfoBox>
      </Step>
      <Step number={2} title="Sign in to CodeSandbox">
        ...
        <img
          src="/img/publish-with-vercel/2-sign-in-codesandbox.png"
      ...
      >
        <img
          src="/img/publish-with-vercel/3-create-package-json.png"
  ...
  "scripts": {
    "build": "cp -R . ../public && mv ../public public"
      ...
      >
        <img
          src="/img/publish-with-vercel/5-deployment-tab.png"
      ...
      <Step number={6} title="Sign in to Vercel">
        <img
          src="/img/publish-with-vercel/6-sign-in-vercel.png"
      ...
      >
        <img
          src="/img/publish-with-vercel/7-deploy-with-vercel.png"
          alt={`Click the button titled "Deploy with Vercel"`}
        />
        <img
          src="/img/publish-with-vercel/7-deploy-sandbox.png"
      ...
      <Step number={8} title="View your deployment">
        ...
        <img
          src="/img/publish-with-vercel/8-visit-site.png"
      ...
      <Step number={9} title="Change your domain name">
        ...
        <InfoBox>
          ...
          <p>
            If you want something else, like a .com or .dev domain, you'll need
            to pay money — usually about $12/year. I recommend using{" "}
            <a
            ...
            because they're cheap and honest. (Other domain providers might try
            to increase prices without telling you. Be careful!)
          </p>
          <p>

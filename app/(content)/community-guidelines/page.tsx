    ...
    <div className="my-8">
      <Center>
        ...
        <p>
          ...
          guidelines describe the kinds of behaviors we expect in our community
          so that we can create a positive environment for everybody.
        </p>
        ...
        <div className="mt-12 grid grid-cols-[3fr,4fr,3fr] items-stretch">
          <div className="my-4 flex flex-col overflow-hidden rounded-l-xl border border-r-0 border-gray-300 bg-white text-center">
            ...
            <div className="flex flex-grow flex-col justify-center space-y-1 px-4 py-4">
              <p>
                ...
                background or identity, and we respect the privacy and safety of
                others.
              </p>
            </div>
          </div>
          <div className="z-10 flex flex-col justify-center overflow-hidden rounded-xl border-2 border-indigo-700 bg-white text-center text-lg ring ring-indigo-700/10">
            ...
            <div className="flex flex-grow flex-col justify-center space-y-1 px-4 py-4">
              <p>
                We are a community that embraces learning, supports each other,
                and disagrees gracefully.
              </p>
              <p>We represent the best of human ingenuity and collaboration.</p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <GuidelinePoint title="We are cautious about sharing personal information.">
            <p className="text-gray-800">
              ...
              <strong className="font-semibold">required</strong> to be cautious
              about the personal information you share online. This chart shows
              what you are allowed to share depending on your age.
            </p>
            ...
            <p className="text-gray-800">
              Please keep in mind that even if you are <em>allowed</em> to share
              something, that doesn't necessarily mean it's a good idea. Take
              caution to protect yourself. The moderation team will do their
              best to help assist you with this, but it is ultimately your
              responsibility.
            </p>
          </GuidelinePoint>
        </div>

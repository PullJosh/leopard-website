  ...
  return (
    <>
      <div className="sticky top-[8px] z-30 border-b border-gray-300">
        <Nav title="Privacy Policy" titleHref="/privacy-policy" />
      </div>
      <div className="my-8">
        <Center>
          ...
          <div className="prose prose-sm max-w-max sm:prose-base">
            <div className="flex gap-4 border-t-4 border-indigo-700 bg-gradient-to-b from-indigo-200/50 to-indigo-200/10 p-8">
              ...
              <div>
                ...
                <p>
                  ...
                  below describes exactly what we gather and why, and our code
                  is open source so you can see 100% of what we do.
                </p>
                <p className="!mb-0">
            ...
            <div className="mt-8 grid gap-8 sm:grid-cols-2">
              ...
              <div className="text-sm text-gray-700">
                <p className="!mt-0">
                  ...
                  "collect", "process") your information when you use our
                  services ("Leopard"), such as when you visit our website at
                  leopardjs.com.
                </p>
                <p className="!mb-0">
            ...
            <p>
              ...
              information about you. We only collect personal information that
              you provide to us directly, and we only collect what we absolutely
              need to make the website function.
            </p>
            <div className="grid space-y-4 sm:space-y-0 md:grid-cols-2 md:divide-x-2 md:divide-gray-300">
              <div className="md:pr-8">
                ...
                <ul className="mb-0">
                  ...
                  <li>
                    ...
                    comments and messages on Leopard are public to the whole
                    world.
                  </li>
                  <li>
              ...
              <div className="md:pl-8">
                ...
                <p className="lead text-base">
                  ...
                  by the Leopard core team for the purposes of making Leopard
                  work or responding to your requests.
                </p>
                <ul className="mb-0">
                  <li>
                    <strong>Email addresses:</strong> Used to verify your
                    identity (which helps prevent spam) and contact you
                  </li>
                  <li>
                    <strong>Password:</strong> Securely hashed so that nobody
                    has access to your password, including us.
                  </li>
                  <li>
            ...
            <p>
              ...
              described above, but we do not share any of your private
              information with anyone outside of our core team (as described in
              the "private information" section above).
            </p>
            <p>
              ...
              information on servers provided by Amazon Web Services, and our
              web traffic is routed through Vercel.
            </p>
            ...
            <p>
              ...
              you either by prominantly displaying a notice on the Leopard
              website or by contacting you directly via email.
            </p>
          </div>
        </Center>
      </div>
